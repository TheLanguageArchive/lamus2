...
public class MetadataFileImporter implements FileImporter<MetadataReference> {
    ...
    @Autowired
    public MetadataFileImporter(@Qualifier("ArchiveObjectsDB") ArchiveObjectsDB aoDB, WorkspaceDao wsDao, MetadataAPI mAPI,
	...
	MetadataDocumentType metadataDocumentType = mdDocument.getDocumentType();
