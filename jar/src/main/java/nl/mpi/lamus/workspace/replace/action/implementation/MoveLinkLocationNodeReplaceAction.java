...
/**
 * Implementation of the action to move a link location as part of the tree replacement.
 * 
 * @author guisil
 */
public class MoveLinkLocationNodeReplaceAction extends NodeReplaceAction {
    
    private WorkspaceNode parentNode;
		
    public MoveLinkLocationNodeReplaceAction(WorkspaceNode affectedNode, WorkspaceNode parentNode) {
        this.setAffectedNode(affectedNode);
        this.parentNode = parentNode;
    }

    /**
     * @return parent node containing the link to be moved
     */
    ...
    /**
     * @param parentNode parent node containing the link to be moved
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof MoveLinkLocationNodeReplaceAction)) {
                return false;
        }
        MoveLinkLocationNodeReplaceAction other = (MoveLinkLocationNodeReplaceAction) obj;
