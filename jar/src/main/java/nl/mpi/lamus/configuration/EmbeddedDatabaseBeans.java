...
//                .addScript("classpath:hsql_corpusstructure_create.sql")
    ...
    public AuthenticationService authenticationSrv() throws Exception {
        IntegratedAuthenticationSrv authenticationSrv = new IntegratedAuthenticationSrv();
        ...
        authenticationSrv.setServices(authenticationServices);
...
//        damlrLdapApi.setKerberosJndiName(null);
    ...
    public AdvAuthorizationService authorizationSrv() throws Exception {
        AmsAuthorizationSrv authorizationSrv = new AmsAuthorizationSrv();
        authorizationSrv.setNodeAuthDao(nodeAuthDao());
        authorizationSrv.setFabricSrv(fabricSrv());
        authorizationSrv.setLicenseSrv(licenseSrv());
        authorizationSrv.setRuleSrv(ruleSrv());
        authorizationSrv.setRuleEvaluationSrv(corpusDbAuthSrv());
