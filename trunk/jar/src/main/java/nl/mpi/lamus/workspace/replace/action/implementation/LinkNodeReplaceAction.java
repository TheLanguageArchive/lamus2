...
/**
 * Implementation of the action to link nodes as part of the tree replacement.
 * 
 * @author guisil
 */
public class LinkNodeReplaceAction extends NodeReplaceAction {
    
    private WorkspaceNode parentNode;

    public LinkNodeReplaceAction(WorkspaceNode affectedNode, WorkspaceNode parentNode) {
        this.setAffectedNode(affectedNode);
        this.parentNode = parentNode;
    }
    
    /**
     * @return parent node to which the affected node will be linked
     */
    ...
    /**
     * @param parentNode parent node to which the affected node will be linked
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof LinkNodeReplaceAction)) {
                return false;
        }
        LinkNodeReplaceAction other = (LinkNodeReplaceAction) obj;
