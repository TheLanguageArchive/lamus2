...
@ContextConfiguration(classes = {LamusConfig.class, LamusJdbcWorkspaceDao.class}, loader = AnnotationConfigContextLoader.class)
public class LamusConfigTest {
